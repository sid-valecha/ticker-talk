...
export default function AnalysisResults({ data }: AnalysisResultsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-white/85 dark:bg-zinc-900/70 p-6 shadow-sm backdrop-blur">
      ...
      {/* Explanation */}
      {data.explanation && (
        <div className="rounded-xl border border-blue-200/80 dark:border-blue-800/80 bg-gradient-to-r from-blue-50/90 to-indigo-50/90 dark:from-blue-950 dark:to-indigo-950 p-6 shadow-sm backdrop-blur">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">
              Analysis Summary
            </h3>
            <span className="text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-100/80 dark:bg-blue-900/40 px-2 py-1 rounded-full">
              AI-generated
            </span>
          </div>
          ...
          <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-4 text-center">
            <span className="font-semibold">Note:</span> This summary is generated
            by an AI model based on computed metrics.
          </p>
        </div>
      )}
      ...
      {/* Disclaimer */}
      <div className="rounded-xl border border-yellow-200/80 dark:border-yellow-800/80 bg-yellow-50/90 dark:bg-yellow-950/70 p-4 text-xs text-zinc-600 dark:text-zinc-400 shadow-sm backdrop-blur">
...
function ChartImage({ title, base64 }: { title: string; base64: string }) {
  return (
    <div className="rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 bg-white/85 dark:bg-zinc-900/70 p-4 shadow-sm backdrop-blur">
